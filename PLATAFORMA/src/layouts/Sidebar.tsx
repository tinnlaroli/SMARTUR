...
const Sidebar = memo(function Sidebar({ isOpen, onClose }: SidebarProps) {
    ...
    const allItems = useMemo<MenuItem[]>(() => [
        ...
        { id: 'company-verification', label: 'Cédulas de Empresa',     icon: ShieldCheck,      path: '/dashboard/verificaciones-empresa',           roles: [1], badge: adminBadges['company-verification'] },
        { id: 'approval',             label: 'Aprobación de Contenido',icon: ClipboardCheck,   path: '/dashboard/aprobacion',                       roles: [1], badge: adminBadges.approval },
        { id: 'disputes',             label: 'Aclaraciones',           icon: MessageSquareDiff,path: '/dashboard/aclaraciones',                     roles: [1], badge: adminBadges.disputes },
        ...
        { id: 'contacts',             label: 'Correos de Contacto',    icon: Mail,             path: '/dashboard/contactos',                        roles: [1] },
