...
const es: DashboardModules = {
    ...
    form: {
        ...
        results: {
            ...
            locatedPlacesBadge: (count, total) => `${count} con ubicación en mapa`,
...
const en: DashboardModules = {
    ...
    form: {
        ...
        results: {
            ...
            locatedPlacesBadge: (count, total) => `${count} with map location`,
...
const fr: DashboardModules = {
    ...
    form: {
        ...
        results: {
            ...
            locatedPlacesBadge: (count, total) => `${count} avec localisation sur la carte`,
