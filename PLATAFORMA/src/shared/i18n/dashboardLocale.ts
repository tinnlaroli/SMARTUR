...
const es: DashboardLocale = {
    ...
    layout: {
        routes: {
            ...
            '/dashboard/itinerarios': 'Rutas',
            '/dashboard/verificacion-empresas': 'Verificación de empresas',
            '/dashboard/servicios-pendientes': 'Servicios pendientes',
            '/dashboard/notificaciones': 'Notificaciones',
            '/dashboard/ml': 'ML / IA',
            '/dashboard/configuracion': 'Configuración',
            '/dashboard/disputas': 'Disputas',
            '/empresa/cambios': 'Cambios del admin',
        },
    ...
    settings: {
        ...
        lightLabel: 'Claro',
        lightDescription: 'Ideal para espacios con mucha luz o sesiones de revisión rápida.',
        darkLabel: 'Oscuro',
        darkDescription: 'Reduce el brillo y mantiene mejor contraste en jornadas largas.',
        alertsTitle: 'Alertas del panel',
        alertsDescription: 'Guarda que avisos quieres mantener activos en esta sesión administrativa.',
        evaluationAlertsLabel: 'Resultados de evaluación',
        ...
        registrationAlertsDescription: 'Activa avisos rapidos cuando se agregan usuarios, compañías o ubicaciones.',
        ...
        preferencesSavedDescription: 'La configuración del panel fue actualizada.',
    },
    home: {
    ...
    widgets: {
        ...
        widgetOptions: {
            showTopServices: {
                label: 'Top servicios',
                description: 'Mantiene visible el ranking de desempeño.',
            },
            ...
            showTopCompanies: {
                label: 'Top empresas',
                description: 'Ranking de empresas por desempeño acumulado.',
            },
        },
        ...
        preferencesSubtitle: 'Se guardan automáticamente en este navegador.',
        reset: 'Restablecer',
        ...
        widgetDescriptions: {
            ...
            'recent-activity':    'Últimas evaluaciones realizadas en el sistema con detalle de servicios y evaluadores.',
            'score-distribution': 'Histograma de rangos de calificación para todas las evaluaciones registradas.',
            'top-companies':      'Ranking de empresas turisticas con mejor desempeño en evaluaciones.',
            'b2b-funnel':         'Conversión del pipeline empresarial: companias → servicios → evaluaciones.',
            'operational-mix':    'Distribución de tipos de servicios: hoteles, restaurantes, tours y transporte.',
            ...
            'lang-switch':        'Cambia rápidamente el idioma de la interfaz y el tema visual (claro/oscuro).',
        },
        /* ── Edit-mode toolbar ── */
        editAdd: 'Agregar',
        ...
        editDone: 'Listo',
        /* ── ML Telemetry widget ── */
        mlTelemetryTitle: 'Telemetría IA',
        ...
        coverageCompanies: 'Compañías',
        coverageServices: 'Servicios',
        coveragePoi: 'Puntos de Interés',
        /* ── B2B Funnel ── */
        b2bTitle: 'Embudo B2B',
        b2bSubtitle: 'Conversión del pipeline empresarial',
        b2bCompanies: 'Compañías',
        ...
        shellDragHintBoth: 'Arrastra para cambiar tamaño',
        shellRemoveLabel: (label) => `Eliminar widget ${label}`,
    },
    mlObservability: {
        title: 'ML / Observabilidad IA',
        subtitle: 'Motor híbrido v4: LightFM WARP + CF Pearson + Random Forest + ContentModel',
        trainBtn: 'Entrenar modelo',
        trainingLabel: 'Entrenando en segundo plano...',
        refreshBtn: 'Actualizar',
        bannerTitle: 'Recolección de datos activa',
        bannerDesc: 'La app móvil envía señales implícitas (tiempo en pantalla, favoritos, filtros, ubicacion GPS) y calificaciones explícitas (1-5 estrellas). LightFM WARP usa el perfil del viajero (tiposTurismo, grupo, presupuesto) + features del POI (categoría, precio, distancia). El motor mejora automáticamente con cada re-entrenamiento usando las tablas user_interaction y user_rating.',
        errorRetry: 'Reintentar',
        kpiRmse: 'Mejor RMSE almacenado',
        kpiRmseSub: 'Menor = mejor predicción',
        kpiLatency: 'Latencia promedio (30d)',
        kpiLatencySub: 'Por solicitud de recomendación',
        kpiSessions: 'Sesiones totales (30d)',
        kpiSessionsSub: 'Solicitudes de recomendación',
        kpiCtr: 'Click-through rate (30d)',
        kpiCtrSub: (clicked, total) => `${clicked} clicks / ${total} recomendaciones`,
        kpiCtrEmpty: 'Sin datos aún',
        chartTitle: 'Sesiones de recomendación — últimos 30 días',
        chartSessionsName: 'Sesiones',
        tableTitle: 'Comparación de algoritmos',
        tableSubtitle: (best, alpha, n) =>
            `En producción: ${best} · α = ${alpha}${n != null ? ` · n = ${n.toLocaleString('es-MX')}` : ''}`,
        ...
        toastTrainDesc: 'El modelo está re-entrenando en segundo plano (RF + GBM + LightFM). Los resultados se actualizarán automáticamente en ~8 minutos.',
    ...
    viewModel: {
        ...
        scoreAttention: 'Zona de atención',
        scoreImprove: 'Prioridad de mejora',
        noHistoryTrend: 'Aún no hay suficiente historial para mostrar una tendencia confiable.',
        ...
        topServicesSummary: (name) => `${name} lidera por desempeño y volumen visible.`,
...
const en: DashboardLocale = {
    ...
    layout: {
        routes: {
            ...
            '/dashboard/itinerarios': 'Routes',
            '/dashboard/verificacion-empresas': 'Company verification',
            '/dashboard/servicios-pendientes': 'Pending services',
            '/dashboard/notificaciones': 'Notifications',
            '/dashboard/ml': 'ML / AI',
            '/dashboard/configuracion': 'Settings',
            '/dashboard/disputas': 'Disputes',
            '/empresa/cambios': 'Admin changes',
        },
...
const fr: DashboardLocale = {
    ...
    layout: {
        routes: {
            ...
            '/dashboard/actividades': 'Activités',
            '/dashboard/certificaciones': 'Certifications',
            '/dashboard/poi': "Points d'intérêt",
            '/dashboard/estadisticas': 'Statistiques',
            '/dashboard/instrumentos': 'Instruments',
            '/dashboard/comunidad': 'Communauté',
            '/dashboard/itinerarios': 'Itinéraires',
            '/dashboard/verificacion-empresas': 'Vérification entreprises',
            '/dashboard/servicios-pendientes': 'Services en attente',
            '/dashboard/notificaciones': 'Notifications',
            '/dashboard/ml': 'ML / IA',
            '/dashboard/configuracion': 'Configuration',
            '/dashboard/disputas': 'Litiges',
            '/empresa/cambios': 'Modifications admin',
        },
        notificationTitle: 'Notifications',
