// src/api/smartur.js
// Backend de recomendaciones (puerto 8000) - usar variable distinta al backend principal (3000)
const API_BASE = import.meta.env.VITE_SMARTUR_API_URL || "http://localhost:8000";
