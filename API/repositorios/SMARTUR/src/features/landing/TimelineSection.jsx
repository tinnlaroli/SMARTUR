      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <span className="relative inline-block">
            ...
            <span
              className="absolute bottom-0 left-0 w-full h-3 bg-purple -z-1 opacity-20"
              style={{ bottom: "5px" }}
            ></span>
          </span>
        </motion.h2>
        <div className="relative">
          <div className="hidden sm:block absolute top-1/2 left-0 right-0 h-1 bg-gray-200 transform -translate-y-1/2 z-0"></div>
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 sm:gap-4 relative z-10">
            {[
              ...
              {
                icon: <FaMap className="text-3xl text-cyan" />,
              ...
              >
                <div className="relative mb-4 flex flex-col items-center">
                  <div className="w-16 h-16 bg-purple rounded-full flex items-center justify-center mx-auto text-white text-xl font-bold shadow-lg mb-2">
                    {step.step}
                  </div>
