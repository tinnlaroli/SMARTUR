...
`,
    ...
    {
        // Módulo WellTur (turismo de bienestar). Estas tablas/columnas existían
        // solo como archivos SQL sueltos en API/migrations/ (004_wellness*.sql)
        // y nunca entraron al esquema fuente (bd.sql) ni a las migraciones de
        // arranque, por lo que el módulo fallaba con "relation does not exist"
        // y "column does not exist" en BD nuevas (y en producción). Idempotente.
        name: 'v43_wellness_module',
        sql: `
