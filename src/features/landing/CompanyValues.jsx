      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl border-l-4 border-orange hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
            <h2 className="text-2xl font-bold mb-3 font-sans text-orange">MISIÓN</h2>
            <p className="text-gray-700 leading-relaxed flex-grow">
              Conectamos a turistas con experiencias auténticas y personalizadas de la región de Las Altas Montañas. 
              Usamos inteligencia artificial para promover un turismo local y responsable, impulsando la economía y 
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl border-l-4 border-green hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
            <h2 className="text-2xl font-bold mb-3 font-sans text-green">VISIÓN</h2>
            <p className="text-gray-700 leading-relaxed flex-grow">
              Plataforma líder en recomendaciones turísticas de Las Altas Montañas, reconocido por nuestra innovación 
              tecnológica, el impacto positivo en las economías locales y un turismo sostenible e inclusivo.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl border-l-4 border-blue hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
            <h2 className="text-2xl font-bold mb-3 font-sans text-blue">COMPROMISO</h2>
            <p className="text-gray-700 leading-relaxed flex-grow">
              En SMARTUR, creemos en un turismo que beneficia a todos. Nuestro proyecto está directamente alineado 
              con las Objetivas de Desarrollo Sostenible (ODS) de la ONU.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl border-l-4 border-purple hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
            <h2 className="text-2xl font-bold mb-3 font-sans text-purple">HISTORIA</h2>
            <p className="text-gray-700 leading-relaxed flex-grow">
              En 2024, el manual de procedimientos de SMARTUR ganó el "Galardón Turístico Mi Veracruz". Inspirados 
              por este premio, creamos SMARTUR para conectar la tecnología y la cultura, beneficiando a las comunidades 
              locales. Nuestro objetivo es impulsar el turismo y el desarrollo sostenible en la región de Las Altas Montañas.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative w-full h-[400px] overflow-hidden">
            {values.map((value, index) => {
              ...
              const topPositions = ['8%', '15%', '25%', '35%', '45%', '55%', '65%', '75%', '85%', '20%', '30%', '40%', '50%', '60%', '70%', '80%'];
              ...
              return (
                <div
                  key={`value-${index}`}
                  className={`absolute px-4 py-2 rounded-full shadow-md text-sm font-medium ${getColorClass(value.color)} value-slide`}
                  style={{
                    top: top,
                    left: '110%',
            ...
            {values.slice(0, 8).map((value, index) => {
              const topPositions = ['12%', '22%', '32%', '42%', '52%', '62%', '72%', '82%'];
              const top = topPositions[index % topPositions.length];
