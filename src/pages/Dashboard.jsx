...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[auto,1fr] font-sans text-gray-700">
      ...
      <aside className={`fixed lg:static z-50 top-0 left-0 h-full w-64 bg-gradient-to-br from-purple to-blue text-white shadow-xl transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col`}>
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-10 overflow-y-auto relative bg-gray-50">
        ...
        <div className="flex justify-between items-center mb-10 pt-4">
          <motion.h1 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-3xl sm:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple to-blue drop-shadow-xl">
