...
=======
      ...
      >
        ...
        <div className="relative z-10 container mx-auto text-center">
          ...
          >
            Recomendaciones personalizadas que transformarán tu experiencia
            turística en el estado más fascinante de México.
          </motion.p>
      ...
      {/* MODALES */}
>>>>>>> 1786599c03c22c9eced39ffd5d7aa78d4a10143f
      {showLoginModal && (
        <LoginModal
...
=======
      ...
      <section
        id="funciona"
        className="py-16 sm:py-24 px-4 sm:px-6 bg-white relative overflow-hidden"
      >
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            <span className="relative inline-block">
              ...
              <span
                className="absolute bottom-0 left-0 w-full h-3 bg-purple/30 -z-1"
                style={{ bottom: '5px' }}
              ></span>
            </span>
          </motion.h2>
              ...
              {[
                ...
                >
                  <div className="relative mb-4">
                    ...
                    <div className="mt-4 text-purple">{step.icon}</div>
                  </div>
              ...
              <div className="prose prose-lg mx-auto text-white/90">
                <p className="mb-4">
                  <span className="font-semibold">
                    Plataforma inteligente de recomendación de servicios para el
                    desarrollo turístico del estado de Veracruz
                  </span>{' '}
                  (SMARTUR) nació como proyecto ganador del Galardón Turístico
                  "Mi Veracruz 2024", desarrollado por estudiantes de la
                  Universidad Tecnológica del Centro de Veracruz.
                </p>
                <p className="mb-4">
                  Nuestra propuesta "Manual de procedimientos para la
                  implementación de un Chatbot a través de IA como estrategia de
                  innovación en la industria hotelera de Veracruz" fue
                  reconocida en la categoría{' '}
                  <span className="font-semibold">
                    Propuesta de innovación implementada en la calidad del
                    servicio
                  </span>
                  .
                </p>
                <p className="mb-4">
                  <span className="font-semibold text-yellow-300">
                    Proyecto acreditado con pase a ExpoCiencias Nacional 2025,
                    Tamaulipas.
                  </span>
                </p>
                <p>
                  Alineado al <span className="font-semibold">ODS 8</span> de la
                  ONU, promovemos el crecimiento económico sostenible mediante
                  la transformación digital del sector turístico veracruzano.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <footer className="bg-gradient-to-br from-purple to-blue text-white pt-12 pb-6 px-4 sm:px-6">
        <div className="container mx-auto">
          ...
          <div className="pt-6 border-t border-white/10 text-center text-sm text-white/60">
            <p>
              © {new Date().getFullYear()} SMARTUR - Proyecto desarrollado por
              estudiantes de la Universidad Tecnológica del Centro de Veracruz
            </p>
          </div>
        </div>
      </footer>
