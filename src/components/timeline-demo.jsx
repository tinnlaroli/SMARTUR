            ...
            content: (
                <div className="flex flex-col items-center">
                    ...
                    <p className="mb-6 text-xs font-normal text-gray-700">
                        SMARTUR es reconocido como proyecto ganador del Galardón
                        Turístico "Mi Veracruz 2024" por su innovación en el
                        sector turístico.
                    </p>
                    <img
        ...
        },
        {
            ...
            content: (
                <div className="flex flex-col items-center">
                    ...
                    <p className="mb-6 text-xs font-normal text-gray-700">
                        Implementación de chatbot inteligente para mejorar la
                        experiencia de los turistas y la gestión hotelera en
                        Veracruz.
                    </p>
                    <img
        ...
        },
        {
            ...
            content: (
                <div className="flex flex-col items-center">
                    ...
                    <p className="mb-6 text-xs font-normal text-gray-700">
                        SMARTUR obtiene pase a ExpoCiencias Nacional 2025 en
                        Tamaulipas, representando a Veracruz a nivel nacional.
                    </p>
                    <img
        ...
        },
        {
            ...
            content: (
                <div className="flex flex-col items-center">
                    ...
                    <p className="mb-6 text-xs font-normal text-gray-700">
                        Buscamos expandir SMARTUR a más regiones y seguir
                        innovando en el turismo digital.
                    </p>
                </div>
            ),
        },
        ...
        <div className="relative w-full overflow-clip py-8 px-2 sm:px-8 bg-gray-50 rounded-3xl shadow-xl">
            ...
            <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-700 text-base sm:text-lg font-medium animate-fadeInUp">
                    Conoce los hitos y logros más importantes de nuestro equipo
                    y plataforma.
                </p>
            </div>
            {/* Línea del tiempo */}
